...
class MatVecCalculator {
    ...
    protected MatVecCalculator set(Vector3 dst, double x, double y, double z){
        vecs[dst.__id]     = x;
        vecs[dst.__id + 1] = y;
        vecs[dst.__id + 2] = z;
        vecs[dst.__id + 3] = 1;
    ...
    protected double x(Vector3 v){return vecs[v.__id + 0];}
    protected double y(Vector3 v){return vecs[v.__id + 1];}
    protected double z(Vector3 v){return vecs[v.__id + 2];}
    protected double w(Vector3 v){return vecs[v.__id + 3];}
    ...
    public final class VecScope implements AutoCloseable{
