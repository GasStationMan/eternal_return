...
execute if score #onVehicle ER.sys matches 0 if entity @s[tag=rightclick,tag=!rest,nbt={SelectedItem:{id:"minecraft:red_bed",count:1}}] run function eternal_return:system/rest/b1/b1/code
