...
$execute if entity @e[scores = {aj.anim_time = 30},tag= aj.animal_$(animal).animation.death,tag= ER.animal.model,tag= this] run function eternal_return:entity/animal/class/death/b1/code with storage minecraft:temp temp
