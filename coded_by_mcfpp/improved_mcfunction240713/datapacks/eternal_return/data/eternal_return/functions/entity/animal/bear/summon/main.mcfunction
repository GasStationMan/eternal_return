...
execute as @e[type=minecraft:zombie, tag= this, tag= ER.animal.root] at @s run function eternal_return:entity/animal/bear/summon/summon/0
execute as @e[tag=this] run function eternal_return:entity/animal/bear/summon/summon/1
