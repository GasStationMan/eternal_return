...
execute if score #cmp1 sys > #cmp2 sys run function test:test/test/test/test/0 with storage minecraft:temp temp
...
execute if score #j2 sys < #len sys run return run function test:test/test/test/0 with storage minecraft:temp temp
