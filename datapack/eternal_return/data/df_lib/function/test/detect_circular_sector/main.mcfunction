...
function df_lib:float4/vec2d/get_entity_direction/main {rotX : -60}
...
execute at @s if entity @e[type=!minecraft:area_effect_cloud, tag=!executer, distance= ..5] as @e[type=!minecraft:area_effect_cloud, tag=!executer, distance= ..5] run function df_lib:test/detect_circular_sector/b1/code
