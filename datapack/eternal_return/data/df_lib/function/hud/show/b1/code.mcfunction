...
execute if entity @s[tag=!choosing] at @s run function df_lib:hud/show/b1/b1/code
...
$execute if score #rotX ER.sys matches $(x).. run scoreboard players set #rotX ER.sys 800
execute if score #rotY ER.sys matches ..0 run scoreboard players set #rotY ER.sys 1
$execute if score #rotY ER.sys matches $(y).. run scoreboard players set #rotY ER.sys 256
