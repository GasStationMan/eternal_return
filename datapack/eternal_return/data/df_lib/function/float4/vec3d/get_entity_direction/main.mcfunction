...
execute store result score #thisEntityPosY float run data get entity @s Pos[1] 10000
execute store result score #thisEntityPosZ float run data get entity @s Pos[2] 10000
...
scoreboard players reset #thisEntityPosX float
scoreboard players reset #thisEntityPosY float
scoreboard players reset #thisEntityPosZ float
