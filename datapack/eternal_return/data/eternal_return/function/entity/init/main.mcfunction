...
scoreboard players set #ER.animal.alpha.skill_effect_tick ER.sys 50
scoreboard players set #ER.animal.alpha.skill_end_tick ER.sys 65
scoreboard players set #ER.animal.alpha.attack_tick_first ER.sys 7
scoreboard players set #ER.animal.alpha.attack_tick_second ER.sys 30
