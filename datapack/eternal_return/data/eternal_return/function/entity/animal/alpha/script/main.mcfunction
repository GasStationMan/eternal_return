...
execute as @e[tag= ER.animal.alpha] if score #this.ID ER.sys = @s df_id run function eternal_return:entity/animal/alpha/script/b1/code
...
execute if score #this.HP ER.sys matches 1.. run function eternal_return:entity/animal/alpha/script/b4/code
