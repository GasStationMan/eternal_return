...
function eternal_return:entity/animal/wolf/script/b1/code with storage minecraft:temp temp
...
execute if data entity @e[type=minecraft:zombie      ,tag=this,tag=ER.animal.root  ,limit=1] NoAI run function eternal_return:entity/animal/wolf/script/b2/code
execute unless data entity @e[type=minecraft:zombie      ,tag=this,tag=ER.animal.root  ,limit=1] NoAI run function eternal_return:entity/animal/wolf/script/b3/code
function eternal_return:entity/animal/class/optimize/main with storage minecraft:temp temp
execute if score #this.HP ER.sys matches 1.. run function eternal_return:entity/animal/wolf/script/b4/code
