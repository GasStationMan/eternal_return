...
execute at @s as @e[type=minecraft:item_display,tag=ER.animal.model,scores={ER.animal.this=1}] run function eternal_return:entity/animal/wolf/behav/b1/code
