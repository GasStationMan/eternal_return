...
execute if entity @s[tag= aj.animal_boar.animation.attack.playing] on vehicle run function eternal_return:entity/animal/boar/behav/b1/b1/b1/code
execute if entity @p[tag=targeted, distance=..4] run return run function eternal_return:entity/animal/boar/behav/b1/b1/b2/code
