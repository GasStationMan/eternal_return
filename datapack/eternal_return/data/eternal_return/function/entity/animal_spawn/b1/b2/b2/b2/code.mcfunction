...
execute on passengers as @e[tag= ER.animal.model] run function eternal_return:entity/animal_spawn/b1/b2/b2/b2/b2/code
data modify entity @s Pos set from storage minecraft:temp temp.animal[0].Pos
scoreboard players set @s ER.cooltime 80
