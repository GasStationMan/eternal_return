...
execute as @e[type=minecraft:zombie,tag=ER.animal.root] run function eternal_return:entity/hitbox/hitbox/hitbox/hitbox/0
...
execute on passengers run function eternal_return:entity/hitbox/hitbox/hitbox/hitbox/1 with storage minecraft:temp temp
