...
# 모든 핫바 슬롯과 반대 손 슬롯을 클릭 아이템을 변경
    ...
    item replace entity @s hotbar.2 with warped_fungus_on_a_stick[custom_model_data=1,custom_name='""',custom_data={tag:"selectmod"}] 1
    item replace entity @s hotbar.3 with warped_fungus_on_a_stick[custom_model_data=1,custom_name='""',custom_data={tag:"selectmod"}] 1
    item replace entity @s hotbar.4 with warped_fungus_on_a_stick[custom_model_data=1,custom_name='""',custom_data={tag:"selectmod"}] 1
    item replace entity @s hotbar.5 with warped_fungus_on_a_stick[custom_model_data=1,custom_name='""',custom_data={tag:"selectmod"}] 1
