...
# function eternal_return:maps/resurrection/cursor_in_place/..
...
execute store result score #rotX ER.sys run data get storage minecraft:temp temp.Rot[0] 10
execute store result score #rotY ER.sys run data get storage minecraft:temp temp.Rot[1] 10
...
function eternal_return:maps/set_player_pos with storage minecraft:temp coord
data remove storage minecraft:temp coord


$data modify storage minecraft:temp temp merge value {id : $(id), beach:"white",hotel:"white",archery_range:"white",gas_station:"white",school:"white",fire:"white",alley:"white",police:"white",temple:"white",lab:"white",forest:"white",cemetery:"white",pond:"white",stream:"white",hospital:"white",factory:"white",chapel:"white",port:"white",village:"white",storage:"white"}
...
#> 모래사장
execute if score #cnt ER.sys matches 0 if function eternal_return:maps/resurrection/cursor_in_place/beach run \
    function eternal_return:maps/select_place {place:"beach",color:"blue"}

#> 주유소
execute if score #cnt ER.sys matches 0 if function eternal_return:maps/resurrection/cursor_in_place/gas_station run \
    function eternal_return:maps/select_place {place:"gas_station",color:"blue"}

#> 골목
execute if score #cnt ER.sys matches 0 if function eternal_return:maps/resurrection/cursor_in_place/alley run \
    function eternal_return:maps/select_place {place:"alley",color:"blue"}

#> 양궁장
execute if score #cnt ER.sys matches 0 if function eternal_return:maps/resurrection/cursor_in_place/archery_range run \
    function eternal_return:maps/select_place {place:"archery_range",color:"blue"}

#> 학교
execute if score #cnt ER.sys matches 0 if function eternal_return:maps/resurrection/cursor_in_place/school run \
    function eternal_return:maps/select_place {place:"school",color:"blue"}

#> 호텔
execute if score #cnt ER.sys matches 0 if function eternal_return:maps/resurrection/cursor_in_place/hotel run \
    function eternal_return:maps/select_place {place:"hotel",color:"blue"}

#> 소방서
execute if score #cnt ER.sys matches 0 if function eternal_return:maps/resurrection/cursor_in_place/fire run \
    function eternal_return:maps/select_place {place:"fire",color:"blue"}

#> 경찰서
execute if score #cnt ER.sys matches 0 if function eternal_return:maps/resurrection/cursor_in_place/police run \
    function eternal_return:maps/select_place {place:"police",color:"blue"}

#> 절
execute if score #cnt ER.sys matches 0 if function eternal_return:maps/resurrection/cursor_in_place/temple run \
    function eternal_return:maps/select_place {place:"temple",color:"blue"}

#> 숲
execute if score #cnt ER.sys matches 0 if function eternal_return:maps/resurrection/cursor_in_place/forest run \
    function eternal_return:maps/select_place {place:"forest",color:"blue"}

#> 연못
execute if score #cnt ER.sys matches 0 if function eternal_return:maps/resurrection/cursor_in_place/pond run \
    function eternal_return:maps/select_place {place:"pond",color:"blue"}

#> 개울
execute if score #cnt ER.sys matches 0 if function eternal_return:maps/resurrection/cursor_in_place/stream run \
    function eternal_return:maps/select_place {place:"stream",color:"blue"}

#> 묘지
execute if score #cnt ER.sys matches 0 if function eternal_return:maps/resurrection/cursor_in_place/cemetery run \
    function eternal_return:maps/select_place {place:"cemetery",color:"blue"}

#> 병원
execute if score #cnt ER.sys matches 0 if function eternal_return:maps/resurrection/cursor_in_place/hospital run \
    function eternal_return:maps/select_place {place:"hospital",color:"blue"}

#> 고급 주택가
execute if score #cnt ER.sys matches 0 if function eternal_return:maps/resurrection/cursor_in_place/village run \
    function eternal_return:maps/select_place {place:"village",color:"blue"}

#> 성당
execute if score #cnt ER.sys matches 0 if function eternal_return:maps/resurrection/cursor_in_place/chapel run \
    function eternal_return:maps/select_place {place:"chapel",color:"blue"}

#> 창고
execute if score #cnt ER.sys matches 0 if function eternal_return:maps/resurrection/cursor_in_place/storage run \
    function eternal_return:maps/select_place {place:"storage",color:"blue"}

#> 항구
execute if score #cnt ER.sys matches 0 if function eternal_return:maps/resurrection/cursor_in_place/port run \
    function eternal_return:maps/select_place {place:"port",color:"blue"}

#> 공장
execute if score #cnt ER.sys matches 0 if function eternal_return:maps/resurrection/cursor_in_place/factory run \
