...
execute if entity @s[tag=ER.gui_on] run function eternal_return:sys/bossbar/leave_game
execute if entity @s[tag=ingame_ui] run function eternal_return:sys/bossbar/leave_game
