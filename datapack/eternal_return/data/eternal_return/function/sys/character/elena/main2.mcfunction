## 우클릭 했을 때
execute if entity @s[scores={right=1..}] run tag @s add elenaskill
execute if entity @s[scores={right=1..}] run tag @s add elenacool
...
## 스킬
function eternal_return:sys/character/elena/skill
