## 우클릭 했을 때
execute if entity @s[scores={right=1..}] run tag @s add yukiskill
execute if entity @s[scores={right=1..}] run tag @s add yukicool
...
## 스킬
function eternal_return:sys/character/yuki/skill
