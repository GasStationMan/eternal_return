## 우클릭 했을 때
execute if entity @s[scores={right=1..}] run tag @s add heartskill
execute if entity @s[scores={right=1..}] run tag @s add heartcool
...
## 스킬
function eternal_return:sys/character/heart/skill
