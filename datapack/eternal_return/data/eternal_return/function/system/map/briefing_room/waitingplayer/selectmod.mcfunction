## 화면선택 모드
    ## 키 입력
        ...
        execute if entity @s[tag=select_Fkey] run function eternal_return:system/map/briefing_room/waitingplayer/replaceitem_blank
        ...
        execute if entity @s[tag=select_Qkey] run function eternal_return:system/map/briefing_room/waitingplayer/replaceitem_blank
