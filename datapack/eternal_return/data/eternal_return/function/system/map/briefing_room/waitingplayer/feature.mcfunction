...
## 스크롤
    ...
    function eternal_return:system/map/briefing_room/waitingplayer/scroll_updown
...
## 선택 모드
    execute if entity @s[tag=select_mod] run function eternal_return:system/map/briefing_room/waitingplayer/selectmod
