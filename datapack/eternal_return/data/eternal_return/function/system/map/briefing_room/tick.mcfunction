...
## 캐릭터를 선택하기 전
execute as @a[tag=ingame_ui,tag=!wait_bar,tag=briefing_room,tag=!waitingPlayer] run function eternal_return:system/map/briefing_room/waitingplayer/give_tag

execute if entity @a[tag=waitingPlayer] as @a[tag=waitingPlayer] run function eternal_return:system/map/briefing_room/waitingplayer/feature
...
# 곧 시작
execute if entity @a[tag=now_bar] run function eternal_return:system/bossbar/now_bar
...
# 일정 인원 이하인 경우
execute if score #wait.remaining CT1 matches 7.. run function eternal_return:system/bossbar/set/now_score
execute if entity @a[tag=!wait_bar] run function eternal_return:system/bossbar/set/wait_score
execute if score #wait.player CT1 matches ..9 if score #wait.remaining.tick CT1 matches 10.. if entity @a[tag=wait_bar] run function eternal_return:system/bossbar/set/wait_score
