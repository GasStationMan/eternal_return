...
execute store result storage minecraft:temp temp.animalStr.id int 1 run scoreboard players get #tempID ER.sys
data modify storage minecraft:temp temp.animalStr.Pos set from entity @n[tag=this, tag=ER.animal.root] Pos
data modify storage minecraft:temp temp.animal append from storage minecraft:temp temp.animalStr
data remove storage minecraft:temp temp.animalStr
